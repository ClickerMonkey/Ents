 ...
 * components, has a set of controllers that modifies it's state, and 
 * optionally a view which handles the drawing.
 * <br/><br/>
 * An entity by default is not expired, is visible, and is enabled.
 * <br/><br/>
 * When an entity expires, the object containing the Entity is responsible 
 * from removing it from the world. An expired Entity is one that is ready
 * to be entirely forgotten by the world and should not be drawn or updated.
 * However, an Entity could be expired and the {@link #update(Object)} and
...
public class Entity
{
	...
	/**
	 * Instantiates a custom entity without a {@link Template}. This entity 
	 * will have no components, controller, or view by default.
	 */
	public Entity()
	{
	 ...
	 * the Template's components, controllers, and view. 
	 * <br/><br/>
	 ...
	 * to the Template of this Entity will be the given template however
	 * changes to the resulting Template will not modify it's parent.
	 * <br/><br/>
	 ...
	 * enabled use the {@link #setControllerEnabled(Controller, boolean)} 
	 * method (or any of it's variants).
	 * <br/><br/>
	 * Do not modify a Template directly, this should only be done before any
	 * Entity is created with it. A problem arises when a distinct component
	 * is added to a Template that already has Entity instances... the instances
	 ...
	 * notifying the new Template that it has a new Entity instance.
	 * 
	 * @param newTemplate
	 * 		The new template of the Entity.
	 * @return
	 * 		True if the template given is different than the existing template.
	 */
	...
	/**
	 * @return 
	 * 		True if the Entity has expired, otherwise false.
	 */
	 ...
	 * @return
	 * 		True if this Entity has the given view (or an alternative), 
	 * 		otherwise false.
	 */
	...
	/**
	 * Sets whether this entity is enabled or not. An enabled entity (true) 
	 * will invoke it's controllers when {@link #update(Object)} is called, 
	 * while a disabled entity (false) does not. 
	 * <br/><br/>
	 ...
	 * @return 
	 * 		True if this Entity has the component (or an alternative), 
	 * 		otherwise false.
	 */
	 ...
	 * @return
	 * 		True if this entity has all of the components (or their 
	 ...
	 * by a BitSet, where the i'th bit in the set is set to true to indicate 
	 * the component with the ID equaling "i" is present.
	 * 
	 * @param components
	 * 		The BitSet of components.
	 * @return
	 * 		True if this entity has all of the components specified in the 
	 ...
	 * fastest way of getting an Entity's component value. 
	 * <br/><br/>
	 * {@link #gets(Component)} or {@link #gets(Component, Object)} should be
	 * used to safely get a value of a component. 
	 * <br/><br/>
	 ...
	 * between all Entities that have the same Template, it may be a 
	 * dynamically created value, or it may be an aliased value (existing under
	 * a different component in reality).
	 * 
	 * @param component
	 * 		The component to get the value of.
	 * @return
	 * 		The value of the component on this Entity.
	 ...
	 * slower, alternative to {@link #get(Component)}. An alternative 
	 * method to this is {@link #gets(Component, Object)} which returns a 
	 * defined value if the Entity doesn't have the component.
	 * <br/><br/>
	 * {@link #get(Component)} should be used if you are confident an 
	 * Entity has the component, or if you want an exception to be thrown to
	 * indicate a logical error in your code.
	 * <br/><br/>
	 * The return value of null should not be used as an indicator to whether
	 * an Entity has a component, since null is a valid component value.
	 * <br/><br/>
	 * Depending on the component type, the value returned may be a value that
	 * is shared between all Entities that have the component, it may be shared
	 * between all Entities that have the same Template, it may be a 
	 ...
	 * 		The component to get the value of.
	 * @return
	 * 		The value of the component on this Entity or null.
	 */
	 ...
	 * alternative method to this is {@link #gets(Component)} which returns  
	 * null if the Entity doesn't have the component.
	 * <br/><br/>
	 * {@link #get(Component)} should be used if you are confident an 
	 * Entity has the component, or if you want an exception to be thrown to
	 * indicate a logical error in your code.
	 ...
	 * should not be used as an indicator to whether an Entity has a component, 
	 * since missingValue could actually exist on the Entity.
	 * <br/><br/>
	 * Depending on the component type, the value returned may be a value that
	 * is shared between all Entities that have the component, it may be shared
	 * between all Entities that have the same Template, it may be a 
	 ...
	 * 		The component to get the value of.
	 * @return
	 * 		The value of the component on this Entity or missingValue.
	 */
	...
	/**
	 * Sets the value of the component on this Entity. This is an unsafe 
	 * method, meaning if the Entity does not have the component then a 
	 * {@link NullPointerException} will be thrown. This method is also the
	 * fastest way of setting an Entity's component value. 
	 * <br/><br/>
	 * {@link #sets(Component, Object)} should be used to safely set the
	 * value of a component on the Entity.
	 * <br/><br/>
	 * Depending on the component type, the value set may be a value that
	 * is shared between all Entities that have the component, it may be shared
	 * between all Entities that have the same Template, it may be a 
	 * dynamically set value, or it may be an aliased value (existing under
	 * a different component in reality).
	 * 
	 * @param component
	 ...
	 * returns false if this Entity does not have the given component. This is
	 * a safe yet slower alternative to {@link #set(Component, Object)}, thus
	 ...
	 * 		The new value of the component.
	 * @return
	 * 		True if the Entity has the component and the value was set, 
	 * 		otherwise false. 
	 */
	 ...
	 * component, however it is the quicker method. 
	 * <br/><br/>
	 * This is useful when a dynamic component could be in use,
	 * depending on the {@link DynamicValue} implementation it may save on
	 * unnecessarily creating a short-lived object.
	 * <br/><br/>
	 * {@link #takes(Component, Object)} should be used as the safe alternative
	 * to this method.
	 * <br/><br/>
	 * Not all component types may support taking, therefore a reference
	 * to an object other than target may be returned.
	 * 
	 * @param component
	 ...
	 * @return
	 * 		The reference to target, or the reference to another object if
	 ...
	 * {@link #take(Component, Object)} and will return null if this Entity 
	 ...
	 * 		The target value to set and return with the component's value.
	 * @return
	 * 		The reference to target, null, or the reference to another object 
	 ...
	 * {@link #fill(EntityFilter)} on any child Entities this Entity may
	 * contain.
	 * 
	 * @param filter
	 * 		The filter to fill.
